...
import { ChatHistoryRepository } from 'repositories';
import { CreateChatHistorySchema } from 'validators';
...
export class SocketService {
  ...
  private async addHistoryToChat(dto: CreateChatHistorySchema) {
    await this.historyRepo.create(dto);
  }
}
